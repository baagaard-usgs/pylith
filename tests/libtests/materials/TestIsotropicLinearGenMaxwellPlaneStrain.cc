...
pylith::materials::TestIsotropicLinearGenMaxwellPlaneStrain::setUp(void) {
    ...
    GenericComponent::setName("TestIsotropicLinearGenMaxwellPlaneStrain");
...
// Test auxFieldSetup().
void
pylith::materials::TestIsotropicLinearGenMaxwellPlaneStrain::test_auxiliaryFieldSetup(void) {
    PYLITH_METHOD_BEGIN;
