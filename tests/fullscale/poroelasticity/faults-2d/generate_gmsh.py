...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        c1 = gmsh.model.geo.add_curve_loop([self.l_yneg0, self.l_fault, self.l_ypos0, self.l_xneg])
        self.s_xneg = gmsh.model.geo.add_plane_surface([c1])
        c2 = gmsh.model.geo.add_curve_loop([self.l_yneg1, self.l_xpos, self.l_ypos1, -self.l_fault])
    ...
    def mark(self):
        ...
        """
        materials = (
            MaterialGroup(tag=1, entities=[self.s_xneg, self.s_xpos]),
        )
