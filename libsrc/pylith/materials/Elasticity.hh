...
public:
    ...
    std::vector<InterfaceResidualKernels> getInterfaceKernelsResidual(const pylith::topology::Field& solution,
                                                                      pylith::feassemble::IntegratorInterface::FaceEnum face) const override;
...
private:
    ...
    std::shared_ptr<pylith::materials::RheologyElasticity> _rheology; ///< Bulk rheology for elasticity.
