...
void
pylith::faults::KinSrcRamp::slipFn(const pylith::integer dim,
    ...
    const pylith::integer i_impulseDuration = 3;
...
void
pylith::faults::KinSrcRamp::slipRateFn(const pylith::integer dim,
                                       const pylith::integer numS,
                                       const pylith::integer numA,
                                       const pylith::integer sOff[],
                                       const pylith::integer sOff_x[],
...
void
pylith::faults::KinSrcRamp::slipAccFn(const pylith::integer dim,
                                      const pylith::integer numS,
                                      const pylith::integer numA,
                                      const pylith::integer sOff[],
                                      const pylith::integer sOff_x[],
