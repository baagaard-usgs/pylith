...
#include "pylith/materials/PoroIsotropicLinearMaxwell.hh" // USES PoroIsotropicLinearMaxwell
...
namespace pylith {
    class TestLinearPoroviscoelasticity;
    class TestLinearPoroviscoelasticity_Data;
}

/// C++ class for testing poroelasticity using a variety of MMS tests.
class pylith::TestLinearPoroviscoelasticity : public pylith::testing::MMSTest {
        // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:
     ...
     */
    TestLinearPoroviscoelasticity(TestLinearPoroviscoelasticity_Data* data);

    /// Destructor.
    ~TestLinearPoroviscoelasticity(void);
...
protected:
    ...
    TestLinearPoroviscoelasticity_Data* _data; ///< Test parameters.


}; // class TestLinearPoroviscoelasticity

class pylith::TestLinearPoroviscoelasticity_Data {
        // PUBLIC METHODS /////////////////////////////////////////////////////////////////////////////
public:

    /// Constructor
    TestLinearPoroviscoelasticity_Data(void);
...
public:
    ...
    pylith::materials::PoroIsotropicLinearMaxwell rheology; ///< Bulk rheology for materials.
...
}; // TestLinearPoroviscoelasticity_Data
