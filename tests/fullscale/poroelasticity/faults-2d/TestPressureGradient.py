    ...
    def setUp(self):
        ...
        self.checks = [
            ...
            Check(
                ...
                cell_fields = ["density", "solid_bulk_modulus", "shear_modulus"],
                defaults=defaults,
            ),
            Check(
                mesh_entities=["poroelastic"],
            ...
            Check(
                mesh_entities=["bc_disp_xneg", "bc_disp_xpos", "bc_disp_yneg", "bc_disp_ypos"],
                filename="output/{name}-{mesh_entity}_info.h5",
...
class TestQuadGmsh(TestCase):
    ...
    def setUp(self):
        ...
        TestCase.run_pylith(self, self.name, ["pressuregradient.cfg", "pressuregradient_quad.cfg"])
        return
...
class TestTriGmsh(TestCase):
    ...
    def setUp(self):
        ...
        TestCase.run_pylith(self, self.name, ["pressuregradient.cfg", "pressuregradient_tri.cfg"])
        return
