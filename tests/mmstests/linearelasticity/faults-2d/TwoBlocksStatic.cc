...
private:
    ...
    static const double X_FAULT; // normalized
    static const double Y_DISP; // normalized
...
const double pylith::_TwoBlocksStatic::X_FAULT = +2.0;
const double pylith::_TwoBlocksStatic::Y_DISP = 0.75e-3;
