...
#include "TestIsotropicLinearGenMaxwell3D.hh" // Implementation of class methods
...
// Setup testing data.
void
pylith::materials::TestIsotropicLinearGenMaxwell3D::setUp(void) {
    TestMaterial::setUp();
...
void
pylith::materials::TestIsotropicLinearGenMaxwell3D::testAccessors(void) {
    PYLITH_METHOD_BEGIN;
...
// Test auxFieldSetup().
void
pylith::materials::TestIsotropicLinearGenMaxwell3D::test_auxiliaryFieldSetup(void) {
    PYLITH_METHOD_BEGIN;
    ...
    { // Viscous strain
        ...
        const pylith::topology::Field::SubfieldInfo& info = _mymaterial->_auxiliaryField->subfieldInfo(label);
        CPPUNIT_ASSERT_EQUAL(size_t(18), info.description.numComponents);
        CPPUNIT_ASSERT_EQUAL(std::string(label), info.description.label);
        CPPUNIT_ASSERT_EQUAL(pylith::topology::Field::OTHER, info.description.vectorFieldType);
        CPPUNIT_ASSERT_EQUAL(1.0, info.description.scale);
        CPPUNIT_ASSERT_EQUAL(1, info.fe.basisOrder);
...
// Test getAuxField().
void
pylith::materials::TestIsotropicLinearGenMaxwell3D::testGetAuxField(void) {
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
// Destructor
pylith::materials::TestIsotropicLinearGenMaxwell3D_Data::~TestIsotropicLinearGenMaxwell3D_Data(void) {}
