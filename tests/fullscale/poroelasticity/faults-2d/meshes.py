...
class TriGmsh(object):
    ...
    ENTITIES = {
        ...
        "bc_disp_yneg": MeshEntity(ncells=4, ncorners=2, nvertices=5+1),
        "bc_disp_ypos": MeshEntity(ncells=4, ncorners=2, nvertices=5+1),
        "bc_press_xneg": MeshEntity(ncells=4, ncorners=2, nvertices=5),
        "bc_press_xpos": MeshEntity(ncells=4, ncorners=2, nvertices=5),
    }
