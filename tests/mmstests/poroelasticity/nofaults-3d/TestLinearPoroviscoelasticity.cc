...
#include "TestLinearPoroviscoelasticity.hh" // Implementation of class methods
...
// ------------------------------------------------------------------------------------------------
// Constuctor.
pylith::TestLinearPoroviscoelasticity::TestLinearPoroviscoelasticity(TestLinearPoroviscoelasticity_Data* data) :
    _data(data) {
    assert(_data);
...
// ------------------------------------------------------------------------------------------------
// Destructor.
pylith::TestLinearPoroviscoelasticity::~TestLinearPoroviscoelasticity(void) {
...
void
pylith::TestLinearPoroviscoelasticity::_initialize(void) {
    PYLITH_METHOD_BEGIN;
    assert(_mesh);
    assert(_data);
...
void
pylith::TestLinearPoroviscoelasticity::_setExactSolution(void) {
...
// ------------------------------------------------------------------------------------------------
// Constructor
pylith::TestLinearPoroviscoelasticity_Data::TestLinearPoroviscoelasticity_Data(void) :
    spaceDim(3),
    meshFilename(NULL),
    meshOptions(NULL),
    boundaryLabel(NULL),
