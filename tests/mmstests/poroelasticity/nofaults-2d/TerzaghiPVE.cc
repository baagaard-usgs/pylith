...
#include "TerzaghiPVE.hh" // Implementation of cases
...
const double pylith::_TerzaghiPVE::LENGTH_SCALE = 1.0e+3;
const double pylith::_TerzaghiPVE::TIME_SCALE = 2.0;
const double pylith::_TerzaghiPVE::PRESSURE_SCALE = 2.25e+10;

const double pylith::_TerzaghiPVE::PRESSURE0 = 4.0e+6;
const double pylith::_TerzaghiPVE::XMAX = 8.0e+3;


// ------------------------------------------------------------------------------------------------
pylith::TestLinearPoroviscoelasticity_Data*
pylith::TerzaghiPVE::QuadQ2Q1Q1(void) {
    TestLinearPoroviscoelasticity_Data* data = pylith::_TerzaghiPVE::createData();assert(data);
