...
class pylith::materials::PoroIsotropicLinearMaxwell : public pylith::materials::RheologyPoroelasticity {
...
public:
    ...
    /// Default constructor.
    PoroIsotropicLinearMaxwell(void);
...
private:
    ...
    PoroIsotropicLinearMaxwell(const PoroIsotropicLinearMaxwell&); ///< Not implemented.
    const PoroIsotropicLinearMaxwell& operator=(const PoroIsotropicLinearMaxwell&); ///< Not implemented
