...
// ------------------------------------------------------------------------------------------------
// Constructor.
pylith::meshio::TestDataWriterHDF5Submesh::TestDataWriterHDF5Submesh(TestDataWriterHDF5Submesh_Data* data) :
    _data(data) {
...
// ------------------------------------------------------------------------------------------------
// Destructor.
pylith::meshio::TestDataWriterHDF5Submesh::~TestDataWriterHDF5Submesh(void) {
    PYLITH_METHOD_BEGIN;
